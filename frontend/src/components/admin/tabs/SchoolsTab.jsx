...
const SchoolsTab = ({ 
  ...
  const filteredSchools = schools.filter(school => 
    ...
    (school.schoolCode || school.code)?.toLowerCase().includes(searchQuery.toLowerCase())
  );
          ...
          <TableBody>
            {filteredSchools.map((school) => (
              <TableRow key={school.id}>
                <TableCell>
                  <Chip label={school.schoolCode || school.code} size="small" color="primary" variant="outlined" />
                </TableCell>
