      ...
      const fetchSchools = async () => {
        try {
          const response = await axios.get(
            `${process.env.REACT_APP_BACKEND_URL}/api/rest/schools/list`,
  ...
  if (addNewTeacher) {
    return (
      <AddNewTeacher
        ...
        onTeacherAdded={() => {
          // Auto-refresh the list after adding a new teacher
          handleFetchData(selectedSchool);
          setAddNewTeacher(false);
        }}
      />
    ...
    <div className="schoolContainer">
      ...
      <Dialog open={bulkUploadOpen} onClose={() => setBulkUploadOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          ...
          <Button onClick={handleBulkUpload} variant="contained" disabled={bulkUploading || !bulkFile}>
