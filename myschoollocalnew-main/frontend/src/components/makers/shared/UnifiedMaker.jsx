      ...
      <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minHeight: { xs: '60vh', md: 'auto' } }}>
        ...
        <Paper sx={{ p: { xs: 0.5, md: 1 }, borderRadius: 0, display: 'flex', alignItems: 'center', gap: { xs: 0.5, md: 1 }, flexWrap: 'wrap', overflowX: 'auto' }}>
          ...
          <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap' }}>
            <Button variant="outlined" size="small" startIcon={<PrintIcon />} onClick={handlePrint} sx={{ display: { xs: 'none', md: 'inline-flex' } }}>Print</Button>
            <Button variant="outlined" size="small" startIcon={<SaveIcon />} onClick={() => setSaveDialog(true)} sx={{ fontSize: { xs: '0.7rem', md: '0.875rem' }, minWidth: { xs: 60, md: 80 } }}>Save</Button>
            <Button variant="outlined" size="small" startIcon={<LoadIcon />} onClick={() => setLoadDialog(true)} sx={{ fontSize: { xs: '0.7rem', md: '0.875rem' }, minWidth: { xs: 60, md: 80 } }}>Load</Button>
          </Box>
          <Tooltip title="Export as PNG image">
            <Button variant="contained" startIcon={<DownloadIcon />} onClick={() => handleExport('png')}>Export</Button>
          </Tooltip>
        </Paper>
